...
GTEST_TEST(ParticlesClassTest, TestAddSetGet) {
    ...
    EXPECT_TRUE(CompareMatrices(particles.get_velocity(0), vel1,
                std::numeric_limits<double>::epsilon()));
    EXPECT_EQ(particles.get_position_x(0), pos1(0));
    EXPECT_EQ(particles.get_position_y(0), pos1(1));
    EXPECT_EQ(particles.get_position_z(0), pos1(2));
    ...
    EXPECT_TRUE(CompareMatrices(particles.get_velocity(1), vel2,
                std::numeric_limits<double>::epsilon()));
    EXPECT_EQ(particles.get_position_x(1), pos2(0));
    EXPECT_EQ(particles.get_position_y(1), pos2(1));
    EXPECT_EQ(particles.get_position_z(1), pos2(2));
